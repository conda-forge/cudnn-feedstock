...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/cudnn-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/cudnn-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add cudnn cudnn-jit libcudnn libcudnn-dev libcudnn-jit libcudnn-jit-dev
# for installing globally
pixi global install cudnn cudnn-jit libcudnn libcudnn-dev libcudnn-jit libcudnn-jit-dev
```
...
It is possible to list all of the versions of `cudnn` available on your platform:
...
```
pixi search cudnn --channel conda-forge
```
